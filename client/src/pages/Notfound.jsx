...
export default function NotFound() {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-sm h-[400px] bg-[url('/gradientBackground.png')] bg-cover bg-no-repeat min-h-screen">
            ...
            <div className="flex items-center gap-4 mt-6">
                <button onClick={() => navigate('/')} type="button" className="bg-indigo-500 hover:bg-indigo-600 px-7 py-2.5 text-white rounded active:scale-95 transition-all">
                    Go back home
                </button>
