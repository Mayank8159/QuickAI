...
const Footer = () => {
  return (
    <footer className="px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 pt-10 w-full text-gray-500 bg-gray-100 shadow-lg mt-20">
        ...
        <div className="flex flex-col gap-10 md:flex-row md:justify-end md:items-start w-full">
          ...
          <div className="w-full max-w-md">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              />
              <button className="bg-primary w-full sm:w-28 h-10 text-white rounded text-sm cursor-pointer">
                Subscribe
              </button>
            </div>
          </div>
